...
def plot_overlap_J(overlap_J,L,N,beta,tot_steps):
    ...
    plt.savefig("../imag/Overlap_J_L{:d}_N{:d}_beta{:3.1f}_step{:d}_log.eps".format(L,N,beta,tot_steps),format='eps')
    plt.savefig("../imag/Overlap_J_L{:d}_N{:d}_beta{:3.1f}_step{:d}_log.png".format(L,N,beta,tot_steps),format='png')
...
def plot_overlap_S(overlap_S,L,M,N,beta,tot_steps):
    ...
    plt.savefig("../imag/Overlap_S_L{:d}_M{:d}_N{:d}_beta{:3.1f}_step{:d}_log.eps".format(L,M,N,beta,tot_steps),format='eps')
    plt.savefig("../imag/Overlap_S_L{:d}_M{:d}_N{:d}_beta{:3.1f}_step{:d}_log.png".format(L,M,N,beta,tot_steps),format='png')
