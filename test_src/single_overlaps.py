...
def plot_overlap_J(overlap_J,L,N,beta,tot_steps):
    ...
    plt.savefig("../imag/Overlap_J_L{:d}_N{:d}_beta{:2.0f}_step{:d}.eps".format(L,N,beta,tot_steps),format='eps')
    plt.savefig("../imag/Overlap_J_L{:d}_N{:d}_beta{:2.0f}_step{:d}.png".format(L,N,beta,tot_steps),format='png')
...
def plot_overlap_S(overlap_S,L,M,N,beta,tot_steps):
    ...
    plt.savefig("../imag/Overlap_S_L{:d}_M{:d}_N{:d}_beta{:2.0f}_step{:d}.eps".format(L,M,N,beta,tot_steps),format='eps')
    plt.savefig("../imag/Overlap_S_L{:d}_M{:d}_N{:d}_beta{:2.0f}_step{:d}.png".format(L,M,N,beta,tot_steps),format='png')
...
if __name__ == '__main__':
    ...
    for i in range(nk):
        ...
        beta = beta_tmp[0]
        J = np.load('{}/{}/J_old_host_L{:d}_N{:d}_beta{:3.1f}_step{:d}.npy'.format(data_dir,timestamp_list[i],L,N,beta,tot_steps))
        J0 = np.load('{}/{}/J_old_guest_L{:d}_N{:d}_beta{:3.1f}_step{:d}.npy'.format(data_dir,timestamp_list[i],L,N,beta,tot_steps))
        S = np.load('{}/{}/S_old_host_L{:d}_M{:d}_N{:d}_beta{:3.1f}_step{:d}.npy'.format(data_dir,timestamp_list[i],L,M,N,beta,tot_steps))
        S0 = np.load('{}/{}/S_old_guest_L{:d}_M{:d}_N{:d}_beta{:3.1f}_step{:d}.npy'.format(data_dir,timestamp_list[i],L,M,N,beta,tot_steps))
